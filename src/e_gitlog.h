 ...
 *
 * S.Pinigin copy o_cvslog.h and replace cvs/Cvs/CVS to git/Git/GIT.
 *
...
class EGitLog: public EBuffer {
public:
    EGitLog(int createFlags, EModel **ARoot, const char *Directory, const char *OnFiles);
    ~EGitLog();
