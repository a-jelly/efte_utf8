 ...
 *
 * S.Pinigin copy o_cvsbase.h and replace cvs/Cvs/CVS to git/Git/GIT.
 *
...
public:
    ...
    EGitBase(int createFlags, EModel **ARoot, const char *ATitle);
    ~EGitBase();
...
int AddGitIgnoreRegexp(const char *);
