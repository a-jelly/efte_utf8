...
typedef enum {
    ...
    //<cmd_p4> P4 (Perforce) Support
    ExP4,
    /// Ask for P4 options and run P4
    ExRunP4,
    /// Run configured P4 command
    ExViewP4,
    /// View P4 output
    ExClearP4Messages,
    /// Clear P4 messages
    ExP4Diff,
    /// Ask for P4 diff options and run P4
    ExRunP4Diff,
    /// Run configured P4 diff command
    ExViewP4Diff,
    /// View P4 diff output
    ExP4Submit,
    /// Ask for P4 submit options and run P4
    ExRunP4Submit,
    /// Run configured P4 submit command
    ExViewP4Log,
    /// View P4 log
    ExP4Edit,
    /// Run p4 edit on current file

    //<cmd_git> Git Support
    ExGit,
    /// Ask for Git options and run Git
    ExRunGit,
    /// Run configured Git command
    ExViewGit,
    /// View Git output
    ExClearGitMessages,
    /// Clear Git messages
    ExGitDiff,
    /// Ask for Git diff options
    ExRunGitDiff,
    /// Run Git diff
    ExViewGitDiff,
    /// View Git diff output
    ExGitCommit,
    /// Ask for Git commit options
    ExRunGitCommit,
    /// Run Git commit
    ExViewGitLog,
    /// View Git log
