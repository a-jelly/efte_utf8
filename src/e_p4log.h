 ...
 *
 * S.Pinigin copy o_cvslog.h and replace cvs/Cvs/CVS to p4/P4/P4.
 *
...
class EP4Log: public EBuffer {
public:
    EP4Log(int createFlags, EModel **ARoot, const char *Directory, const char *OnFiles);
    ~EP4Log();
